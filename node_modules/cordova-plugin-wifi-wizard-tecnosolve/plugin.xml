...
<plugin xmlns="http://apache.org/cordova/ns/plugins/1.0"
	...
	<repo>https://github.com/Tecnosolve/WifiWizard/</repo>
	...
	<platform name="android">
		...
		<config-file target="res/xml/config.xml" parent="/*">
			<feature name="WifiWizard">
				<param name="android-package" value="com.danishin.wifiwizard.WifiWizard" />
				<param name="onload" value="true" />
			</feature>
		</config-file>
		
		<source-file src="src/android/src/com/danishin/wifiwizard/WifiWizard.java" target-dir="src/com/danishin/wifiwizard" />
	</platform>
